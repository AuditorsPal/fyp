...
import 'package:auditorpal/screens/AuditorsViews/AuditorHome.dart';
import 'package:auditorpal/screens/OrganizationViews/OrganizationHome.dart';
        ...
        body: Stack(
          children: [
            ...
            Container(
              ...
              child:widget.userType=="auditor"? Text(
                'Welcome\nAuditor',
                                    ...
                                    onPressed: () async{
                                      ...
                                      if(response=="Signed in"){
                                        ...
                                        Navigator.pushAndRemoveUntil(
                                          context,
                                          MaterialPageRoute(builder: (context) => widget.userType=="auditor"? AuditorHome():OrganizerHome()), (_) => false
                                        );
                                      }
                                      else{
                                        Loader.hide();
