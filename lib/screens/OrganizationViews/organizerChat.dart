...
class OrganizerChat extends StatefulWidget {
  ...
  final String email;
  const OrganizerChat({Key? key, required this.otherUserID,required this.currentUserID,required this.email}) : super(key: key);

  @override
  State<OrganizerChat> createState() => _AlertChatState();
}

class _AlertChatState extends State<OrganizerChat> {
  ...
  void onSendMessage(String content, int type) {
    if (content.trim().isNotEmpty) {
      ...
      WriteMessageService.sendMessageAdvisor(content, type, widget.currentUserID,
    ...
    return Flexible(
        child: StreamBuilder<QuerySnapshot>(
          stream: WriteMessageService.getChatStream(
              widget.currentUserID,  widget.otherUserID, _limit),
