...
class _project_detailsState extends State<project_details> {
  ...
  addReview(String reviewNote, double reviewRating) async {
    review = await WriteService.writeReview(
        reviewNote, reviewRating, project["auditorID"], project["organizerID"]);
  }
                  ...
                  Center(
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        final response =
                            await WriteService.deleteProject(projId);
                        if (response == "1") {
                          Loader.hide();
                          MotionToast.success(
                            title: const Text(
                            ...
                            description: const Text('Project Deleted!'),
